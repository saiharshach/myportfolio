...
import LogoE from '../../assets/images/HH.jpg'
...
const Sidebar = () => {
    ...
    return(
        <div className = 'nav-bar'> 
            ...
            <ul>
                <li>
                    <a target = "_blank" rel = "noreferrer" href = "https://www.linkedin.com/in/saiharsha-choppari-16ba22272/">
                        <FontAwesomeIcon icon={faLinkedin} color = "#4d4d4e" />
                    </a>
                </li>
                <li>
                    <a target = "_blank" rel = "noreferrer" href = "https://github.com/saiharshach">
